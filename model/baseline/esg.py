...
from .esg_util import Dilated_Inception, MixProp, LayerNorm
        ...
        for i in range(1, n_layers+1):            
            ...
            self.append(
                Extractor(residual_channels, conv_channels, kernel_set, dilation_factor, gcn_depth, st_embedding_dim, dy_embedding_dim, 
                 skip_channels, t_len_i, num_nodes, layer_norm_affline, propalpha, dropout, dy_interval)
            )
...
class ESG(nn.Module):
    ...
    def forward(self, input, g_d, node_emb1, node_emb2):
        """
